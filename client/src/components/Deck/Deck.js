        ...
        <div id="deck">
            ...
            {deck.length === 0 ?
                <div className='deck-text-container'>
                    ...
                    <p>Vous pouvez ajouter des Pokemons à votre deck sur la <Link to="/" id="deck-nodeck-link"> Page d'Accueil</Link></p>
                </div>
                :
            ...
            <div className="deck-container">
                ...
                {deck && deck.map((pokemon) => (
                    ...
                    <div key={pokemon.id} className="deck-pokemon">
                        ...
                        <div className='deck-infos-container'>
                            <img className="deck-image" src={pokemon.url} alt={pokemon.nom}></img>
                            <Box>
